...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "primary", colorKey: variant === variants.PRIMARY ? "primary" : "textSubtle" }, props)));
    }
...
var StyledToggle = styled__default['default'].div(templateObject_3$4 || (templateObject_3$4 = __makeTemplateObject(["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 40px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 72px;\n"], ["\n  align-items: center;\n  background-color: ", ";\n  border-radius: 24px;\n  box-shadow: ", ";\n  cursor: pointer;\n  display: inline-flex;\n  height: 40px;\n  position: relative;\n  transition: background-color 200ms;\n  width: 72px;\n"])), function (_a) {
    ...
    return theme.colors[checked ? "success" : "textSubtle"];
}, function (_a) {
    var theme = _a.theme;
    return theme.shadows.inset;
});
...
var Icon$M = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React__default['default'].createElement("path", { d: "M19 19C19 19.2652 18.8946 19.5196 18.7071 19.7071C18.5196 19.8946 18.2652 20 18 20H4C3.73478 20 3.48043 19.8946 3.29289 19.7071C3.10536 19.5196 3 19.2652 3 19V10H0L10.327 0.612C10.5111 0.444478 10.7511 0.351643 11 0.351643C11.2489 0.351643 11.4889 0.444478 11.673 0.612L22 10H19V19Z", fill: "white" }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$O = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React__default['default'].createElement("path", { d: "M0 10H4V19H0V10ZM14 6H18V19H14V6ZM7 0H11V19H7V0Z", fill: "white" })));
};

var Icon$P = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React__default['default'].createElement("path", { d: "M6 0V20H2V16H0V14H2V11H0V9H2V6H0V4H2V0H6ZM18.005 0C19.107 0 20 0.898 20 1.99V18.01C20 19.109 19.107 20 18.005 20H8V0H18.005Z", fill: "white" })));
};
...
var Icon$R = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React__default['default'].createElement("path", { d: "M5 10C3.9 10 3 10.9 3 12C3 13.1 3.9 14 5 14C6.1 14 7 13.1 7 12C7 10.9 6.1 10 5 10ZM19 10C17.9 10 17 10.9 17 12C17 13.1 17.9 14 19 14C20.1 14 21 13.1 21 12C21 10.9 20.1 10 19 10ZM12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z", fill: "white" })));
};
...
var Icon$T = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React__default['default'].createElement("path", { d: "M13 6L17.371 7.749C17.751 7.9 18 8.269 18 8.677V18C18 18.552 17.552 19 17 19H1C0.448 19 0 18.552 0 18V8.677C0 8.268 0.249 7.9 0.629 7.749L5 6H13ZM17 11H5V16H17V11ZM13 0C13.552 0 14 0.448 14 1V5H4V1C4 0.448 4.448 0 5 0H13Z", fill: "white" }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$U = function (props) {
    return (React__default['default'].createElement("svg", { width: "26", height: "26", fill: "white", xmlns: "http://www.w3.org/2000/svg", "fill-rule": "evenodd", "clip-rule": "evenodd" },
...
var Icon$X = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React__default['default'].createElement("path", { d: "M10 20C4.477 20 0 15.523 0 10C0 4.477 4.477 0 10 0C15.523 0 20 4.477 20 10C20 15.523 15.523 20 10 20ZM10 7H6V9H15L10 4V7ZM5 11L10 16V13H14V11H5Z", fill: "white" }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$10 = function (props) {
    return (React__default['default'].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "white", width: "26", height: "26", viewBox: "0 0 28 26" },
        React__default['default'].createElement("path", { d: "M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z" }))
    // <Svg viewBox="0 0 506.161 506.161" {...props}>
    //   <path
...
var socials = [
    ...
    // },
    {
        label: "Telegram",
        icon: "TelegramIcon",
        href: "https://t.me/PrivacySwap",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/PrivacySwap",
    },
    {
        label: "Reddit",
        icon: "RedditIcon",
        href: "https://www.reddit.com/r/privacyswap/",
    },
    {
        label: "Youtube",
        icon: "HandshakeIcon",
        href: "https://www.youtube.com/channel/UCH9bH2LGSc9b4lCC62luUwg",
    },
    {
        label: "Medium",
        icon: "SunIcon",
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { style: { padding: "" + (isPushed ? "0 50px" : "0 16px") }, onClick: handleClick, className: className },
            icon,
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React__default['default'].createElement("div", null,
                React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
        ...
        return (React__default['default'].createElement(MenuEntry, { isPushed: isPushed, key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#00151e", backgroundDisabled: "#00151e", contrast: "#00151e", invertedContrast: "#00151e", input: "#00151e", tertiary: "#F3BA2F", text: "#F3BA2F", textDisabled: "#BDC2C4", textSubtle: "#FFFFFF", borderColor: "#F3BA2F", card: "#00151e", heroColor: "#f2f5ff", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#27262c", heroColor: "#f2f5f", gradients: {
