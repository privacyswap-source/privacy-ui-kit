...
var Icon$O = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React.createElement("path", { d: "M0 10H4V19H0V10ZM14 6H18V19H14V6ZM7 0H11V19H7V0Z", fill: "white" })));
};

var Icon$P = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React.createElement("path", { d: "M6 0V20H2V16H0V14H2V11H0V9H2V6H0V4H2V0H6ZM18.005 0C19.107 0 20 0.898 20 1.99V18.01C20 19.109 19.107 20 18.005 20H8V0H18.005Z", fill: "white" })));
};
...
var Icon$T = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React.createElement("path", { d: "M13 6L17.371 7.749C17.751 7.9 18 8.269 18 8.677V18C18 18.552 17.552 19 17 19H1C0.448 19 0 18.552 0 18V8.677C0 8.268 0.249 7.9 0.629 7.749L5 6H13ZM17 11H5V16H17V11ZM13 0C13.552 0 14 0.448 14 1V5H4V1C4 0.448 4.448 0 5 0H13Z", fill: "white" }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$U = function (props) {
    return (React.createElement("svg", { width: "26", height: "26", fill: "white", xmlns: "http://www.w3.org/2000/svg", "fill-rule": "evenodd", "clip-rule": "evenodd" },
...
var Icon$X = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props, { fill: "none", xmlns: "http://www.w3.org/2000/svg" }),
        React.createElement("path", { d: "M10 20C4.477 20 0 15.523 0 10C0 4.477 4.477 0 10 0C15.523 0 20 4.477 20 10C20 15.523 15.523 20 10 20ZM10 7H6V9H15L10 4V7ZM5 11L10 16V13H14V11H5Z", fill: "white" }))
    // <Svg viewBox="0 0 24 24" {...props}>
...
var Icon$10 = function (props) {
    return (React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "white", width: "26", height: "26", viewBox: "0 0 28 26" },
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { style: { padding: "" + (isPushed ? "0 50px" : "0 16px") }, onClick: handleClick, className: className },
            icon,
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        if (entry.items) {
            return (React.createElement("div", null,
                React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass }, isPushed &&
        ...
        return (React.createElement(MenuEntry, { isPushed: isPushed, key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
